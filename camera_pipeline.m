...
if isequal(filename,0) || isequal(pathname,0)
    ...
    if (handles.lastSliderVal == 1) 
        ...
        system_command = [fullfile('.','dngOneExeSDK','dng_validate.exe -16 -1 ')...
            '"' stage1OutputFileName '"' ' ' '"' inputFileName '"'];
    ...
    if (handles.lastSliderVal == 2) 
        ...
        system_command = [fullfile('.','dngOneExeSDK','dng_validate.exe -16 -2 ')...
            '"' stage2OutputFileName '"' ' ' '"' inputFileName '"'];
        system(system_command);   
    ...
    if (handles.lastSliderVal == 3) 
        ...
        system_command = [fullfile('.','dngOneExeSDK','dng_validate.exe -16 -2 ')...
            '"' stage3OutputFileName '"' ' ' '"' inputFileName '"'];
        system(system_command);   
    ...
    if (handles.lastSliderVal == 4) 
        ...
        if (get(handles.radiobutton17,'Value') == 0 && get(handles.radiobutton18,'Value') == 1 )
            ...
            fprintf(fileID,'%d\n',a);
            fclose(fileID);
            system_command = [fullfile('.','dngOneExeSDK','dng_validate.exe -16 -cs1 -tif ')...
            '"' stage4OutputFileName '"' ' ' '"' inputFileName '"'];
            system(system_command);   
            delete(stage4OutputFileName);
        end 
        
        system_command = [fullfile('.','dngOneExeSDK','dng_validate.exe -16 -3 ')...
            '"' stage4OutputFileName '"' ' ' '"' inputFileName '"'];
        system(system_command);   
    ...
    if (handles.lastSliderVal == 5) 
        ...
        system_command = [fullfile('.','dngOneExeSDK','dng_validate.exe -16 -cs1 -tif ')...
            '"' stage5OutputFileName '"' ' ' '"' inputFileName '"'];
        system(system_command);   
    ...
    if (handles.lastSliderVal == 6) 
        ...
        system_command = [fullfile('.','dngOneExeSDK','dng_validate.exe -16 -cs1 -tif ')...
            '"' stage6OutputFileName '"' ' ' '"' inputFileName '"'];
        system(system_command);   
    ...
    if (handles.lastSliderVal == 7) 
        ...
        system_command = [fullfile('.','dngOneExeSDK','dng_validate.exe -16 -cs1 -tif ')...
            '"' stage7OutputFileName '"' ' ' '"' inputFileName '"'];
        system(system_command);   
    ...
    if (handles.lastSliderVal == 8) 
        ...
        system_command = [fullfile('.','dngOneExeSDK','dng_validate.exe -16 -cs1 -tif ')...
            '"' stage8OutputFileName '"' ' ' '"' inputFileName '"'];
        system(system_command);   
    ...
    if (handles.lastSliderVal == 9)
        ...
        system_command = [fullfile('.','dngOneExeSDK','dng_validate.exe -16 -cs1 -tif ')...
            '"' stage9OutputFileName '"' ' ' '"' inputFileName '"'];
        system(system_command);   
    ...
    if (handles.lastSliderVal == 10)
        ...
        system_command = [fullfile('.','dngOneExeSDK','dng_validate.exe -16 -cs1 -tif ')...
            '"' stage10OutputFileName '"' ' ' '"' inputFileName '"'];%comment here when dng save tests. 
...
%         system_command = [fullfile('.','dngOneExeSDK','dng_validate.exe -dng ') stage10OutputFileName ' ' inputFileName]; %comment out here when dng save tests. 
    ...
    if (handles.lastSliderVal == 11) 
        ...
        system_command = [fullfile('.','dngOneExeSDK','dng_validate.exe -16 -cs1 -tif ')...
            '"' stage11OutputFileName '"' ' ' '"' inputFileName '"'];%comment here when dng save tests. 
